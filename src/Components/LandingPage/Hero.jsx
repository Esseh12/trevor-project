		...
		<>
			<section className='bg-[#ff5a3d] relative overflow-hidden pt-26 -mb-32'>
				<div className='max-w-7xl py-8 flex items-center min-h-[60vh] md:min-h-screen'>
					<div className='flex w-full items-center justify-between absolute lg:pl-60'>
						...
						<div className='relative text-white text-left w-full mx-auto z-30 ml-5  sm:ml-0 sm:px-4 sm:max-w-3xl md:max-w-full md:ml-0 md:px-4  md:mx-0 lg:ml-5 '>
							<div className='font-semibold text-2xl  md:text-4xl  md:text-left lg:text-6xl leading-tight mb-8 text-center'>
								<h1>You deserve a </h1>
								<span className='font-bold text-5xl lg:text-[82px] md:text-5xl sm:text-4xl caveat'>
									welcoming, loving world.
								</span>
							</div>
							<p className='text-sm text-center md:text-left lg:text-xl md:text-lg sm:text-base leading-8 max-w-xs mx-auto md:mx-0 lg:max-w-md md:max-w-full sm:max-w-full'>
						...
						<div className='absolute flex-shrink-0 z-10 right-0 mt-8 pr-8 hidden md:block'>
				...
				<div className='block md:hidden pt-8 pb-16'>
					<div className='relative px-4 max-w-4xl mx-auto min-h-[400px]'>
						{/* Image 1 - Bottom left */}
						<div className='absolute left-4 bottom-0 w-32 h-40  z-10'>
							<img
								src={image1}
								alt='Smiling person in yellow cardigan'
						...
						<div className='absolute left-12 bottom-24 w-28 h-36  z-20'>
							<img
								src={image2}
								alt='Smiling person'
								className='w-full h-full object-cover rounded-lg shadow-lg'
						...
						{/* Image 3 - Top center */}
						<div className='absolute left-1/2 top-0 transform -translate-x-1/2 w-36 h-44  z-30'>
							<img
								src={image3}
								alt='Black person in pink top'
								className='w-full h-full object-cover rounded-lg shadow-lg'
						...
						<div className='absolute right-4 top-16 w-40 h-48 z-40'>
							<img
								src={image4}
								alt='Black person in pink top'
								className='w-full h-full object-cover rounded-lg shadow-lg'
						...
						<div className='absolute left-1/2 bottom-8 transform -translate-x-1/2 w-32 h-40  z-15'>
							<img
								src={image5}
								alt='Black person in pink top'
								className='w-full h-full object-cover rounded-lg shadow-lg'
						...
						<div className='absolute right-8 bottom-32 w-28 h-36  z-25'>
							<img
								src={image6}
								alt='Black person in pink top'
								className='w-full h-full object-cover rounded-lg shadow-lg'
